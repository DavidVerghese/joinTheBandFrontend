...
function Home(props) {
  ...
  const searchByName = (e)=>{
    findMusician = props.data.filter((item) => item.fields.Musician === e.target.value)
  }
  ...
  return (
    <div class="intro">
      ...
      <Link to="/form"><button>Make a post!</button></Link>
      <Link to="/profiles"><button>View All Posts</button></Link>
